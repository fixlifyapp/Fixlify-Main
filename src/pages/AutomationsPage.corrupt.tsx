...
const AutomationsPage = () => {
  ...
  const systemVariables: Variable[] = [
    ...
    { key: '{{job_status}}', label: 'Job Status', description: 'Current job status', category: 'Job', source: 'jobs.status', type: 'text', example: 'Scheduled' },
    { key: '{{job_number}}', label: 'Job Number', description: 'Unique job identifier', category: 'Job', source: 'jobs.id', type: 'text', example: 'JOB-2025-001' },
...
{{company_phone}}`
  ...
  const handleAIAutomationCreate = async () => {
    ...
    try {
      ...
      const prompt = `You are an automation builder. Create a JSON automation rule for: "${aiPrompt}"
...
Available statuses: ${statusValues}`;
  ...
  const filteredVariables = getFilteredVariables();
        ...
        <Tabs value={activeView} onValueChange={setActiveView} className="w-full">
          ...
          <TabsContent value="analytics" className="space-y-6 mt-6">
            ...
            <ModernCard variant="elevated">
              <ModernCardHeader>
                <ModernCardTitle>Automation Performance</ModernCardTitle>
              </ModernCardHeader>
              <ModernCardContent>
        ...
        {/* Automation Builder Dialog - Placeholder */}
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="py-4">
              <p className="text-center text-gray-500">
                Automation builder interface will be implemented here...
              </p>
            </div>
          </DialogContent>
        </Dialog>
