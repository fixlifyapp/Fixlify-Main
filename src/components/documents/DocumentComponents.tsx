        ...
        <div>
          ...
          <div className="space-y-2 sm:space-y-3">
            ...
            <div className="space-y-1.5 sm:space-y-2">
              {/* Use purchased phone if available, otherwise fallback to company phone */}
              {(company?.purchasedPhoneNumber || company?.phone) && (
                <div className="flex items-center gap-2 sm:gap-3 text-gray-600 dark:text-gray-300">
                  ...
                  <a
                    href={`tel:${company.purchasedPhoneNumber || company.phone}`}
              ...
              {/* Use auto-generated email if available, otherwise fallback to company email */}
              {(company?.autoGeneratedEmail || company?.email) && (
                <div className="flex items-center gap-2 sm:gap-3 text-gray-600 dark:text-gray-300">
                  <Mail className="h-4 w-4 sm:h-5 sm:w-5 text-gray-400 dark:text-gray-500 flex-shrink-0" aria-hidden="true" />
                  <a
                    href={`mailto:${company.autoGeneratedEmail || company.email}`}
              ...
              {/* GST/HST Number for Canadian tax compliance */}
              {company?.gstHstNumber && (
                <div className="flex items-center gap-2 sm:gap-3 text-gray-600 dark:text-gray-300">
                  <Hash className="h-4 w-4 sm:h-5 sm:w-5 text-gray-400 dark:text-gray-500 flex-shrink-0" aria-hidden="true" />
