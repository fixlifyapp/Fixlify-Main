          ...
          <div className="flex items-start space-x-3 sm:space-x-4 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-xs sm:text-sm text-gray-600 space-y-1">
                ...
                {/* Use purchased phone number if available, otherwise fallback */}
                <p className="break-words">
                  {companyInfo?.purchasedPhoneNumber || companyInfo?.phone}
                </p>
                {/* Use auto-generated Mailgun email if available */}
                <p className="break-words">
                  {companyInfo?.autoGeneratedEmail || companyInfo?.email}
                </p>
                {/* GST/HST Number if available */}
                {companyInfo?.gstHstNumber && (
                  <p className="break-words font-medium text-gray-700">
                    GST/HST #: {companyInfo.gstHstNumber}
                  </p>
                )}
              </div>
            </div>
