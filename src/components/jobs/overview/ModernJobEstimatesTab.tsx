      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-white border border-slate-200 rounded-xl p-4 hover:shadow-sm transition-shadow">
            ...
            <p className="text-2xl font-bold text-slate-800 tabular-nums">{estimatesState.length}</p>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-4 hover:shadow-sm transition-shadow">
            ...
            <p className="text-2xl font-bold text-slate-800 tabular-nums">{formatCurrency(totalEstimateValue)}</p>
          </div>
          ...
          <div className="bg-white border border-amber-200 rounded-xl p-4 hover:shadow-sm transition-shadow">
            ...
            <p className="text-2xl font-bold text-amber-600 tabular-nums">{pendingApproval}</p>
          </div>
        </div>
