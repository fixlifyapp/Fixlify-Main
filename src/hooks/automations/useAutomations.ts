...
export const useAutomations = () => {
  ...
  }, [user?.id, profile?.organization_id, loadAutomations, loadMetrics]);
  ...
  }, [user?.id, profile?.organization_id, loadAutomations]);
  ...
  }, [user?.id, profile?.organization_id, loadAutomations, loadTemplates, loadMetrics]);
