// Phone Features Management Script
// Checks and manages Telnyx phone number features

async function checkPhoneNumberFeatures() {
  const phoneNumber = '+12898192158';
  console.log(`\n📱 Проверка настроек номера: ${phoneNumber}`);
