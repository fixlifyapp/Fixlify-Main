...
Create distinctive, production-grade interfaces for Fixlify repair shop management system. Every UI should feel professional, modern, and purpose-built for busy repair shop owners.
...
### For Repair Shop Context
1. **Efficiency First**: Shop owners are busy - minimize clicks
2. **Scannable**: Use visual hierarchy, badges, color coding
3. **Mobile-Ready**: Works on tablets at the counter
4. **Information Dense**: Show relevant data without clutter
5. **Action-Oriented**: Clear CTAs, quick actions
