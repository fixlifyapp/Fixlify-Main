...
-- Using only the columns that exist in the job_overview table
INSERT INTO public.job_overview (job_id, property_type, emergency_contact, billing_contact, warranty_info)
SELECT 
  j.id as job_id,
